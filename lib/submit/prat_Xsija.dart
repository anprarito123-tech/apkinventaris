...
class PratXsija extends StatefulWidget {
  const PratXsija({super.key});

  @override
  State<PratXsija> createState() => _PratXsijaState();
}

class _PratXsijaState extends State<PratXsija> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('DATA KELAS X SIJA ')),
