...
class HanXkpr1 extends StatefulWidget {
  const HanXkpr1({super.key});

  @override
  State<HanXkpr1> createState() => _HanXkpr1State();
}

class _HanXkpr1State extends State<HanXkpr1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('DATA KELAS X KPR 1')),
