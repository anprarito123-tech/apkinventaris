...
class PratXanm2 extends StatefulWidget {
  const PratXanm2({super.key});

  @override
  State<PratXanm2> createState() => _PratXanm2State();
}

class _PratXanm2State extends State<PratXanm2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('DATA KELAS X ANM 2')),
