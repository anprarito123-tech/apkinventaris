...
class PratXanm1 extends StatefulWidget {
  const PratXanm1({super.key});

  @override
  State<PratXanm1> createState() => _PratXanm1State();
}

class _PratXanm1State extends State<PratXanm1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('DATA KELAS X ANM 1')),
