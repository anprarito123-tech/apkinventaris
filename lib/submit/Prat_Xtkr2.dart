...
class PratXtkr2 extends StatefulWidget {
  const PratXtkr2({super.key});

  @override
  State<PratXtkr2> createState() => _PratXtkr2State();
}

class _PratXtkr2State extends State<PratXtkr2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('DATA KELAS X TKR 2 ')),
