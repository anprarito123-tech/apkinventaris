...
class HanXtkj2 extends StatefulWidget {
  const HanXtkj2({super.key});

  @override
  State<HanXtkj2> createState() => _HanXtkj2State();
}

class _HanXtkj2State extends State<HanXtkj2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('DATA KELAS X TKJ 2')),
