...
class HanXkpr2 extends StatefulWidget {
  const HanXkpr2({super.key});

  @override
  State<HanXkpr2> createState() => _HanXkpr2State();
}

class _HanXkpr2State extends State<HanXkpr2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('DATA KELAS X KPR 2')),
