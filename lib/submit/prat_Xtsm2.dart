...
class PratXtsm2 extends StatefulWidget {
  const PratXtsm2({super.key});

  @override
  State<PratXtsm2> createState() => _PratXtsm2State();
}

class _PratXtsm2State extends State<PratXtsm2> {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(title: Text('DATA KELAS X TSM 2 ')),
