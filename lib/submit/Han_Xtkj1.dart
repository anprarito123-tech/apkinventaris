...
class HanXtkj1 extends StatefulWidget {
  const HanXtkj1({super.key});

  @override
  State<HanXtkj1> createState() => _HanXtkj1State();
}

class _HanXtkj1State extends State<HanXtkj1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('DATA KELAS X TKJ 1')),
