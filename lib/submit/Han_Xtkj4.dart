...
class HanXtkj4 extends StatefulWidget {
  const HanXtkj4({super.key});

  @override
  State<HanXtkj4> createState() => _HanXtkj4State();
}

class _HanXtkj4State extends State<HanXtkj4> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('DATA KELAS X TKJ 4')),
