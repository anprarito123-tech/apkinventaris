...
class HanXdkv2 extends StatefulWidget {
  const HanXdkv2({super.key});

  @override
  State<HanXdkv2> createState() => _HanXdkv2State();
}

class _HanXdkv2State extends State<HanXdkv2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('DATA KELAS X DKV 2')),
