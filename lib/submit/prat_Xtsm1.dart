...
class PratXtsm1 extends StatefulWidget {
  const PratXtsm1({super.key});

  @override
  State<PratXtsm1> createState() => _PratXtsm1State();
}

class _PratXtsm1State extends State<PratXtsm1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('DATA KELAS X TSM 1 ')),
