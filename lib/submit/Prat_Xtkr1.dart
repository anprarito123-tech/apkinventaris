...
class PratXtkr1 extends StatefulWidget {
  const PratXtkr1({super.key});

  @override
  State<PratXtkr1> createState() => _PratXtkr1State();
}

class _PratXtkr1State extends State<PratXtkr1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('DATA KELAS X TKR 1 ')),
