...
class HanXtkj3 extends StatefulWidget {
  const HanXtkj3({super.key});

  @override
  State<HanXtkj3> createState() => _HanXtkj3State();
}

class _HanXtkj3State extends State<HanXtkj3> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('DATA KELAS X TKJ 3')),
